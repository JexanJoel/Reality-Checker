...
const verdictConfig: Record<string, { emoji: string; color: string; bg: string; border: string; glow: string; cardBg: string }> = {
  "BUILD IT":   { emoji: "🚀", color: "#14532d", bg: "#dcfce7", border: "#86efac", glow: "0 0 0 4px rgba(22,163,74,0.15),0 16px 48px rgba(22,163,74,0.1)",  cardBg: "linear-gradient(135deg,#f0fdf4,#dcfce7)" },
  "NEEDS WORK": { emoji: "🔧", color: "#78350f", bg: "#fef9c3", border: "#fde047", glow: "0 0 0 4px rgba(234,179,8,0.15),0 16px 48px rgba(234,179,8,0.1)",  cardBg: "linear-gradient(135deg,#fffbeb,#fef9c3)" },
  "RISKY":      { emoji: "⚠️", color: "#7c2d12", bg: "#ffedd5", border: "#fb923c", glow: "0 0 0 4px rgba(234,88,12,0.15),0 16px 48px rgba(234,88,12,0.1)",  cardBg: "linear-gradient(135deg,#fff7ed,#ffedd5)" },
  "PASS":       { emoji: "❌", color: "#7f1d1d", bg: "#fee2e2", border: "#fca5a5", glow: "0 0 0 4px rgba(220,38,38,0.15),0 16px 48px rgba(220,38,38,0.1)",  cardBg: "linear-gradient(135deg,#fef2f2,#fee2e2)" },
}
